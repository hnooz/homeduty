                ...
                <div class="space-y-6">
                    <Card class="rounded-3xl border-border/70 shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>
                                {{ members.length }} people currently belong to
                                this Home Group.
                            </CardDescription>
                        </CardHeader>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <Form
                                            v-bind="
                                                GroupMemberController.update.form(
                                                    {
                                                        group: group.id,
                                        ...
                                        <Form
                                            v-bind="
                                                GroupMemberController.destroy.form(
                                                    {
                                                        group: group.id,
                                                        groupMember: member.id,
                                                    },
                    ...
                    <Card class="rounded-3xl border-border/70 shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Invitations stay active for seven days or until
                                they are accepted.
                            </CardDescription>
                        </CardHeader>
                        <CardContent
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        class="flex flex-col gap-3 md:items-end"
                                    >
                                        <Form
                                            v-bind="
                                                GroupInvitationController.acceptDirect.form(
                                                    {
                                                        group: group.id,
                                                        groupInvitation:
                                                            invitation.token,
                                        ...
                                        >
                                            {{ invitation.registeredUserName }}
                                            already has an account and can be
                                            added immediately.
                                        </p>
                                        <p
                                            v-else
                                            class="text-xs text-muted-foreground md:text-right"
                                        >
                                            An account will be created and a
                                        ...
                                        <Form
                                            v-bind="
                                                GroupInvitationController.destroy.form(
                                                    {
                                                        group: group.id,
                                                        groupInvitation:
                                                            invitation.token,
